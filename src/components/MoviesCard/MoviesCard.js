...
function MoviesCard( {movie, handleMovieLike} ) {
  ...
  return (
    <div className='movie-card'>
      <a href={movie.trailerLink} target='_blank' rel="noreferrer"><img className='movie-card__image' alt={movie.nameRU} src={`https://api.nomoreparties.co/${movie.image.url ? movie.image.url : movie.image}`}></img></a>
